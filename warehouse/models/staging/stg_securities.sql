...
typed as (
    ...
    select
        ...
        try_cast(cast(target_low_price as varchar) as double)    as target_low_price,
        try_cast(cast(target_high_price as varchar) as double)   as target_high_price,
        try_cast(cast(target_median_price as varchar) as double) as target_median_price,
        try_cast(cast(analyst_opinions as varchar) as double)    as analyst_opinions,
        try_cast(cast(recommendation_mean as varchar) as double) as recommendation_mean,
        try_cast(cast(current_ratio as varchar) as double)       as current_ratio,
        try_cast(cast(forward_pe as varchar) as double)          as forward_pe,
        try_cast(cast(peg_ratio as varchar) as double)           as peg_ratio,
        try_cast(cast(ex_dividend_date as varchar) as double)    as ex_dividend_epoch,
        try_cast(cast(short_percent_of_float as varchar) as double)    as short_percent_of_float,
        try_cast(cast(quarterly_earnings_growth as varchar) as double) as quarterly_earnings_growth,
        recommendation_key,
